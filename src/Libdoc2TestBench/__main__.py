...
if __name__ == "__main__":
    ...
    parser.add_argument("library_or_resource", help="RF library or resource", default='project-dump.zip')
    parser.add_argument('--outfile_path', '-o',nargs='?', help="path to write output, default=project-dump.zip")
    args = parser.parse_args()

    lib = args.library_or_resource
    output_path = args.outfile_path
